...
class AAUserCreationForm(forms.ModelForm):
    ...
    def save(self, commit=True):
        ...
        user = super(AAUserCreationForm, self).save(commit=False)
...
class AAUserChangeForm(forms.ModelForm):
...
# @admin.register(User)
class AAAdminUserAdmin(UserAdmin):
